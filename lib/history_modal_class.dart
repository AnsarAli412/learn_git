...
//
//     final historyModalClass = historyModalClassFromJson(jsonString);

import 'dart:convert';

HistoryModalClass historyModalClassFromJson(String str) => HistoryModalClass.fromJson(json.decode(str));

String historyModalClassToJson(HistoryModalClass data) => json.encode(data.toJson());
...
class HistoryModalClass {
  ...
  factory HistoryModalClass.fromJson(Map<String, dynamic> json) => HistoryModalClass(
