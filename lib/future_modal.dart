...
//
//     final futureModal = futureModalFromJson(jsonString);

import 'dart:convert';

FutureModal futureModalFromJson(String str) => FutureModal.fromJson(json.decode(str));

String futureModalToJson(FutureModal data) => json.encode(data.toJson());
...
class FutureModal {
  ...
  factory FutureModal.fromJson(Map<String, dynamic> json) => FutureModal(
...
enum IconS {
  ...
  CDN_WEATHERAPI_COM_WEATHER_64_X64_DAY_299_PNG,
  CDN_WEATHERAPI_COM_WEATHER_64_X64_DAY_356_PNG,
  CDN_WEATHERAPI_COM_WEATHER_64_X64_NIGHT_176_PNG
}

final iconValues = EnumValues({
  "//cdn.weatherapi.com/weather/64x64/day/176.png": IconS.CDN_WEATHERAPI_COM_WEATHER_64_X64_DAY_176_PNG,
  "//cdn.weatherapi.com/weather/64x64/day/299.png": IconS.CDN_WEATHERAPI_COM_WEATHER_64_X64_DAY_299_PNG,
  "//cdn.weatherapi.com/weather/64x64/day/356.png": IconS.CDN_WEATHERAPI_COM_WEATHER_64_X64_DAY_356_PNG,
  "//cdn.weatherapi.com/weather/64x64/night/176.png": IconS.CDN_WEATHERAPI_COM_WEATHER_64_X64_NIGHT_176_PNG
});
...
final textValues = EnumValues({
  ...
  "Moderate rain at times": Texts.MODERATE_RAIN_AT_TIMES,
  "Patchy rain possible": Texts.PATCHY_RAIN_POSSIBLE
});
